...
public class waits {
    ...
    public void i_set_implicit_timeout() {
        Timeouts timeouts = driver.manage().timeouts();
    ...
    public void i_print_the_text_for_target_element() {
        WebElement targetElement = driver.findElement(By.id("periodicElement"));
        System.out.println(targetElement.getText());
    }
    @When("^I set script timeout$")
    public void i_set_script_timeout() {
        Timeouts timeouts = driver.manage().timeouts();
    ...
    public void i_set_explicit_wait_block_on_target_element_using_exists() {
        Timeouts timeouts = driver.manage().timeouts();
        timeouts.implicitlyWait(5, TimeUnit.SECONDS);
